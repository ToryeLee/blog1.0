...
<html>
  <head>
    ...
    <title>My JSP 'javatype.jsp' starting page</title>
...
<% 
    	...
    	int pageCount = 10;//显示每页记录数
       	...
       	int totalCount=show.getTCount("java类");//页数获取总
       	...
       	ArrayList<Article> Alist=show.getTArticle(currentPage,pageCount,"java类");
         ...
         <c:if test="${requestScope.flag==0 }"><script>alert("抱歉，暂时没有找到有关该文章的信息！")</script></c:if>
      	<form action="SearchServlet?n=2" method="post" >
